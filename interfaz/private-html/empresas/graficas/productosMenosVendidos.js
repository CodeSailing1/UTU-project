document.addEventListener('DOMContentLoaded', (event) => {
    const ctx = document.getElementById('productosMenosVendidos');
    console.log(ctx)
    const URL_RANKING_MENOS = '/UTU-project/logica/empresas/rankingProductosMenosVendidosEmpresas.php';
    let chart;
    ...
    const updateChart = async () => {
        let result = await getData(URL_RANKING_MENOS);
        if (result) {
            console.log(result);
            createChart(result);
        }
