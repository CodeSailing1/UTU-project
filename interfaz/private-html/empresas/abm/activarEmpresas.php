...
<body class="row">
    ...
    <main class="col ">
        <aside id="options" class="list-group d-flex flex-row justify-content-center align-items-center gap-5"
            ...
            <a href="activarEmpresas.php" class="btn btn-outline-success me-2">activar</a>
        </aside>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="staticBackdropLabel">Esta seguro que desea activar este producto?</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-footer justify-content-center">
        <button type="button" class="btn btn-outline-success" data-bs-dismiss="modal">No</button>
        <button type="button" class="btn btn-secundary" id="activateProductos">Si</button>
      </div>
    </div>
  </div>
</div>
    </main>
    <script src="../scripts/showProductsByIdAct.js"></script>
    <script src="../scripts/activateProducto.js"></script>
